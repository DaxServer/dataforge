import type { ApiErrors, ErrorCode } from '@backend/types/error-schemas'
...
export class ApiErrorHandler {
   ...
   */
  static notFoundError(resource: string = 'Resource', identifier?: string): ApiErrors {
   ...
   */
  static notFoundErrorWithData(resource: string = 'Resource', identifier?: string): ApiErrors {
    const message = identifier
      ? `${resource} with identifier '${identifier}' not found`
      : `${resource} not found`
    return this.createErrorWithData('NOT_FOUND', message, [])
