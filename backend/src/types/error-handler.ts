import type { ErrorCode, ErrorResponseWithData } from '@backend/types/error-schemas'
...
export class ApiErrorHandler {
   ...
   */
  static notFoundError(resource: string = 'Resource', identifier?: string): ErrorResponseWithData {
   ...
   */
  static missingFilePathError(message: string = 'File path is required'): ErrorResponseWithData {
   ...
   */
  static fileNotFoundError(filePath?: string): ErrorResponseWithData {
