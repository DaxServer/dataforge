  ...
  <div class="-mx-6 -px-6">
    ...
    >
      ...
      <Column
        ...
        :header="col.header"
        :pt="{
          headerCell: { class: 'whitespace-nowrap !p-2 min-w-1 max-w-100' },
          bodyCell: { class: 'break-words align-top !p-2 min-w-1 max-w-100' },
        }"
      >
        <template #body="slotProps">
          <span v-html="replaceLineBreaks(linkifyText(slotProps.data[col.field]))"></span>
        </template>
      </Column>
    </DataTable>
  </div>
